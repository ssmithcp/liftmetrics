  ...
  <section className='text-lg flex flex-col md:block'>
    ...
    <div className='flex flex-col items-center md:flex-row'>
      ...
      <div>
        ...
        <P>To contact me about a job opportunity, reach out on <SafeExternalLink target={ config.get('linkedinURL') }>LinkedIn</SafeExternalLink> or shoot me an email at <span className='font-mono text-base'>ssmith <strong>dot</strong> cp <strong>at</strong> gmail <strong>dot</strong> com</span>. Check out some of my other projects on <SafeExternalLink target={ config.get('githubURL') }>GitHub</SafeExternalLink>.</P>
    ...
    <P><InternalLink to='/signup'>Create an account</InternalLink> and start kicking ass!</P>
  </section>
)
